...
# All configuration is read from config.yaml — no .env needed.
...
# ---- Generate runtime-config.js for the frontend ----
# This file is loaded by the browser at runtime (via <script> in index.html),
# so the frontend knows which port the API is on — no .env or compile-time
# environment variables needed.
RUNTIME_CONFIG="$SCRIPT_DIR/public/runtime-config.js"
...
EOF
echo "Generated $RUNTIME_CONFIG (API_PORT=${API_PORT})"
